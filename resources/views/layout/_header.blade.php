...
<div id="menu" class="row no-gutters sticky-top">
    ...
    <div class="menu-hover-detail">
        ...
        <div id="hover-application" hidden>
            <h5 id="eng-title">STUDY ABROAD</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
        ...
        <div id="hover-planning" hidden>
            <h5 id="eng-title">ENTRANCE PLANNING</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
        ...
        <div id="hover-visa" hidden>
            <h5 id="eng-title">VISA SERVICES</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
        ...
        <div id="hover-overseas" hidden>
            <h5 id="eng-title">OVERSEAS SERVICES</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
        ...
        <div id="hover-job" hidden>
            <h5 id="eng-title">CAREER TRAINING</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
        ...
        <div id="hover-summer" hidden>
            <h5 id="eng-title">SUMMER CAMP</h5><img class="ml-4" src="{{asset('images/home/sample-icon.png')}}" width="30px">
